...
//            var sendLoginButton = formLogin.getElementsByClassName('submit')[0];

            var formReg = document.getElementById('formReg');
            var sendRegButton = formReg.getElementsByClassName('submit')[0];


//            sendLoginButton.addEventListener('click',AjaxLoginFormRequest,false);
            sendRegButton.addEventListener('click', AjaxRegFormRequest, false);


            function AjaxRegFormRequest() {
